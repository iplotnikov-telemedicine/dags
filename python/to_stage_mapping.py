...
def stg_load(op_kwargs, *op_args, **kwargs):
    logging.info(f'op_kwargs is: {op_kwargs}')
    ...
    get_customers_task = op_kwargs[get_customers_task]
    logging.info(f'get_customers_task is: {get_customers_task}')
    (comp_id, ext_schema) = get_customers_task
