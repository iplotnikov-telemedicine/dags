...
def upsert_brands(customer_data, schema, table, date_column):
    ...
    if table_exists is None:
        ...
        query = f'''
            ...
            select {comp_id} as comp_id, id, brand_id, brand_name, wm_id, sync_created_at, sync_updated_at, description, is_internal
        ...
        logging.info(f'Table {schema}.{table} already exists. Skiping.')
...
with DAG(
    dag_id='update_everything_task_mapping',
    max_active_tasks=8,
